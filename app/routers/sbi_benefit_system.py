...
from use_cases.sbi_benefit_system.use_case import UseCase

from routers.router import Router


class SbiBenefitSystemRouter(Router):
    def __init__(self, use_case: UseCase):
        super().__init__(prefix="/pensions/sbi_benefit_system")
    ...
    async def save(self):
        logger.info("save sbi_benefit_system")
        try:
